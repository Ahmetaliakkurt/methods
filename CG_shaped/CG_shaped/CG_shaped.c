...
int main() {
    ...
    for (iter = 0; iter < MAX_ITERATIONS; iter++) {
        ...
        // Her 1000 iterasyonda residual değeri ekrana yazdırılıyor
        if (iter % 1000 == 0) {
        ...
        // Beta değeri hesaplanarak p vektörü güncelleniyor
    ...
    // Sadece kalp içindeki noktaların çözümünü dosyaya yaz
